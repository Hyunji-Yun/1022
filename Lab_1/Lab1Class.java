...
public class Lab1Class {
   ...
   public static String minutesSeconds(int seconds) {
      ...
      String result = seconds +" seconds is "+ minutes + " minutes and " + rminutes + " seconds";
   ...
   public static String temperature(double fahrenheit) {
	       ...
	       *    Instead, refer to the input parameters of this method.   
	       */
	      double celsius = (double)5/9 * (double)(fahrenheit - 32);    
	      String answer = "Fahrenheit "+String.format("%.1f",fahrenheit)+ " is " + String.format("%.2f",celsius)+" in Celsius";
	      return answer;
   ...
   public static String convertDistance(double cm) {
      ...
      String answer = String.format("%.1f",cm)+ "cm is "+ feet+"ft"+" and "+String.format("%.2f",inches)+"in";
      return answer;
   }
   ...
   public static String fiveyearbalance(double balance, double interest) {
       ...
       *    Instead, refer to the input parameters of this method.   
       */
	   double inter= balance*Math.pow(1+interest/100,5);
	   String str = String.format("%.2f", inter);
	   String answer = "The balance was "+ String.format("%.2f",balance)+" with interset "+String.format("%.2f",interest)+ ", after five years balance is "+str;
   ...
   public static String ageinyears(int days) {
       ...
       */
	   ...
	   int rdays= (int)(days%365);
	   
	   String answer= "Age in days "+days+ ", age in years is "+years+ " with remaining days "+rdays;
   ...
   public static String computeSquareRoot(int n) {
       ...
       */
	   ...
	   double rem = (double)Math.round(100*sqrt)/100;
	   String answer = "The number ("+n+") has square root value ("+rem+")";
   ...
   public static double getBMI(int pounds, int feet, int inches) {
       ...
       */
	   ...
	   double bmi = (double)(pounds/(inch*inch))*703;
	   double ans = (double)Math.round(100*bmi)/100;
   ...
   public static String avg(int a, int b, int c) {
       ...
       *    Instead, refer to the input parameters of this method.   
       */
	   double sum = (0.0+a+b+c)/3;
	   	String answer = "Average of ("+a+ ", "+b+ ", "+c+ ") is "+String.format("%.2f", sum);
         return answer;
